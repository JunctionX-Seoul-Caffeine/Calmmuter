    ...
    return (
        <div className="your-detail-page-wrapper">
            ...
            <div className="your-detail-page-upper-wrapper">
                ...
                <div className="your-detail-page-upper-summary-text">
                    20min, 1.1km
                </div>
                ...
                <div className="your-detail-page-upper-destination">
                    <svg width="20" height="47" viewBox="0 0 20 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 37C10.9167 37 11.6667 36.25 11.6667 35.3333C11.6667 34.4167 10.9167 33.6667 10 33.6667C9.08337 33.6667 8.33337 34.4167 8.33337 35.3333C8.33337 36.25 9.08337 37 10 37ZM10 28.6667C13.5 28.6667 16.6667 31.35 16.6667 35.5C16.6667 38.15 14.625 41.2667 10.55 44.8583C10.2334 45.1333 9.75837 45.1333 9.44171 44.8583C5.37504 41.2667 3.33337 38.15 3.33337 35.5C3.33337 31.35 6.50004 28.6667 10 28.6667Z" fill="#FFCD4B"/>
                ...
                <div className="your-detail-page-upper-recent-rated">
                    ...
                    <div className="your-detail-page-upper-recent-rated-star-wrapper">
                        ...
                        <svg className="your-detail-page-upper-recent-rated-star" width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9.01055 1.33792L10.9329 5.21414C11.0397 5.32182 11.1465 5.42949 11.3601 5.53716L15.5253 6.1832C15.9525 6.29087 16.1661 6.82924 15.8457 7.15225L12.8553 10.1671C12.7485 10.2748 12.6417 10.4901 12.7485 10.5978L13.4961 14.797C13.6029 15.2277 13.0689 15.5507 12.7485 15.3354L9.01055 13.3973C8.90375 13.2896 8.69015 13.2896 8.47656 13.3973L4.73859 15.3354C4.31139 15.5507 3.88419 15.2277 3.99099 14.797L4.73859 10.5978C4.73859 10.3824 4.73859 10.2748 4.63179 10.1671L1.32101 6.93691C1.00062 6.61389 1.21421 6.07553 1.64141 6.07553L5.80658 5.42949C6.02018 5.42949 6.12698 5.32182 6.23377 5.10647L8.15616 1.23025C8.26296 0.907233 8.90375 0.907233 9.01055 1.33792Z" stroke="#A2A4AA" stroke-miterlimit="10"/>
                        </svg>
                    </div>
                </div>
            </div>
            <div className="your-detail-page-your-benefits">
                Your Benefits
            </div>
            <div className="your-detail-page-your-benefits-description">
                How more comfortable your drive was<br/>than other average drives
            </div>
