  ...
  return (
    <>
      ...
      <div className="first-question">
        How was your ride in regards to your health conditions?
      </div>
  ...
  return (
    <div className="modal-wrapper">
      ...
      <div className="modal-subtitle">
        How did you feel about each categories in regards to your health
        condition?
      </div>
    ...
    <>
      ...
      <div className="second-title-wrapper">
        ...
        <div className="second-subtitle">
          It helps us find you more relevant driver.
        </div>
      </div>
      <div className="first-button-wrapper">
        <Link to="/your-detail" className={`first-next-button able`}>
          Done
        </Link>
      </div>
    </>
